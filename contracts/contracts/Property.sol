...
contract Property is ERC1155URIStorage,Ownable, ReentrancyGuard{
    ...
    address public constant marketplace = 0xF4128844b81d421595A09a914096E454DC61F312;
    ...
    function buyShare(uint256 _share) external nonReentrant {
        ...
        require(balanceOf(msg.sender, _share) >= 1, "nft not transferred");
    ...
    function sellShare(uint256 _share) external nonReentrant {
        ...
        require(usdcToken.balanceOf(address(this))>pricePerShare[_share], "not enough funds to sell to contract, please list share");

        safeTransferFrom(msg.sender,address(this),_share,1,"");
        usdcToken.transferFrom(address(this),msg.sender,pricePerShare[_share]);
